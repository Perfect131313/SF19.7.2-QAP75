...
def test_add_pets_with_valid_data_without_photo(name='Фрося!!', animal_type='кот', age='6'):
...
def test_add_pet_negative_age_number(name='Ася', animal_type='cat', age='3', pet_photo='images/Fedor.jpg'):
